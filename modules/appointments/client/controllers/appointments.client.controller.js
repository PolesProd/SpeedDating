(function () {
  ...
  AppointmentsController.$inject = ['$scope', '$state', '$window', 'Authentication', 'appointmentResolve'];

  function AppointmentsController ($scope, $state, $window, Authentication, appointment) {
    var vm = this;
