## Before You Begin
Before you begin we recommend you read about the basic building blocks that assemble a SpeedDating application:
...
## Downloading SpeedDating
There are several ways you can get the SpeedDating boilerplate:

### Cloning The GitHub Repository
The recommended way to get SpeedDating is to use git to directly clone the SpeedDating repository:

```bash
$ git clone https://github.com/meanjs/mean.git meanjs
```

This will clone the latest version of the SpeedDating repository to a **meanjs** folder.

### Downloading The Repository Zip File
Another way to use the SpeedDating boilerplate is to download a zip copy from the [master branch on GitHub](https://github.com/meanjs/mean/archive/master.zip). You can also do this using the `wget` command:
...
You can run the full test suite included with SpeedDating with the test task:
...
The SpeedDating project integrates Gulp as build tools and task automation.
...
## Getting Started With SpeedDating
